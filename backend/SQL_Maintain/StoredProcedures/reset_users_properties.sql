...
DELETE FROM properties;
		...
		SET userID_p = 69;
		-- Property 1
		CALL add_property(69, "44 Hampshire Place", "St. John's", "NL", 1, "heating_electric", 1, "Cabin", "roof_metal", @propertyID, @message_res);
		CALL add_propertyAppliance(69, @propertyID, "snowblower", "234886598", NOW(), 5, "Poulan Pro", "445", @propertyApplianceID);
		CALL add_propertyAppliance(69, @propertyID, "oven", "76393456120as", NOW(), 2, "Frigidaire Gallery", "GCRE306CAF", @propertyApplianceID);
		CALL add_propertyAppliance(69, @propertyID, "refrigerator", "kjdfgkjh348askjh", NOW(), 2, "LG Electronics", "LRFGC2706S", @propertyApplianceID);
		-- Property 2
		CALL add_property(69, "48 Hampshire Place", "London", "ON", 1, "heating_oil", 1, "Home", "roof_metal", @propertyID, @message_res);
		CALL add_propertyAppliance(69, @propertyID, "clothes washing machine", "ASFJHdkkjshg", NOW(), 5, "Samsung", "WA50R5200AW", @propertyApplianceID);
		CALL add_propertyAppliance(69, @propertyID, "clothes dryer", "ASHFD3457565", NOW(), 2, "Hotpoint", "HTX24EASKWS", @propertyApplianceID);
		CALL add_propertyAppliance(69, @propertyID, "mini split", "DHDD33453456", NOW(), 1, "DuctlessAire", "DA2421-H2", @propertyApplianceID);
		-- Property 3
		CALL add_property(69, "44 Hampshire Place", "St-Louis-de-Ha-Ha!", "NB ", 1, "heating_electric", 1, "Cabin", "roof_metal", @propertyID, @message_res);
		CALL add_propertyAppliance(69, @propertyID, "oil furnace", "fkfdsASDFJAS", NOW(), 50, "MorrHeat", "MH80", @propertyApplianceID);
		CALL add_propertyAppliance(69, @propertyID, "lawnmower", "dlsgkjh", NOW(), NULL, "Troy Built", "Check Don't Change 3 in 1", @propertyApplianceID);
		CALL add_propertyAppliance(69, @propertyID, "woodstove", "ASDF2345644", NOW(), NULL, "Pleasant Hearth", "LWS-2200", @propertyApplianceID);
